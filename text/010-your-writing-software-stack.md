...
This course assumes you have access to a computer with a desktop operating system such as Windows or macOS. If you do not have your own computer, such as if you only have an iPad or other mobile device, please see: [Virtual Student Computing Lab](#virtual-student-computing-lab)

### Writing software tools you'll be using

- **Library Search Tools:** This semester, you will learn how to search effectively for academic sources using the university’s library catalog, [PittCat](https://pittcat.pitt.edu/), and other research databases.

- [**Zotero:**](#zotero) A free tool for collecting and organizing sources, generating citations, and creating reference lists automatically.

- [**Microsoft Word:**](#microsoft-word-and-powerpoint) The main tool for writing and formatting your papers. We’ll learn how to use its built-in features like templates and styles to save time and meet academic formatting standards. See the Microsoft Word and PowerPoint Setup Guide. Special note: Instead of Microsoft Word, some students strongly prefer to use a LaTeX editor such as Overleaf. If you choose to use LaTeX in this course, keep in mind that assignment instructions are based on Microsoft Word and that I cannot provide support for LaTeX issues.

- [**PowerPoint:**](#microsoft-word-and-powerpoint) Used for creating and practicing presentations, especially with tools like Speaker Coach that give feedback on your delivery.

- [**Language Model (LLM):**](#generative-ai-tools) Tools like Claude, Gemini, or Copilot can help with brainstorming, outlining, and improving your drafts when used thoughtfully and ethically.
...
3. Then, after you have those programs installed, reply to the discussion board for this assignment with 2-3 sentences:
...
1. Go to [https://portal.office.com/account/](https://portal.office.com/account/)

2. On the Microsoft sign-in screen, enter your full Pitt email address, including `@pitt.edu`, then click `Next`.

3. You'll be redirected to the Pitt login page. Sign in using your Pitt username and password.

4. After logging in, you’ll be returned to the Microsoft 365 account page.

5. Look for the `Office apps & devices` section. Click the `Install Office` button.

6. Run the installer program once it downloads, and follow the prompts to complete installation.
...
1. Download Zotero. Go to [https://www.zotero.org/download](https://www.zotero.org/download) and choose the version for your computer (Windows, macOS, or Linux).
...
3. Close Microsoft Word if it is open during installation.

4. Launch Zotero. The Microsoft Word plugin should install automatically the first time you open Zotero.

5. Open Word. You should see a `Zotero` tab in the toolbar. This means the plugin is working.
...
1. Open Zotero
2. Go to Preferences
    * On Windows/Linux: `Edit > Preferences`
    * On Mac: `Zotero > Preferences`
...
1. **Open the AI tool in Edge:** Navigate to the AI tool (for example, `https://gemini.google.com/app`) in Microsoft Edge and sign in if necessary.
2. **Open the Menu:** Click the three-dot menu (...) in the top-right corner of the browser window.
3. **Find the Install Option:** In the dropdown menu, go to Apps and then select Install this site as an app.
4. **Confirm Installation:** A small dialog box will appear. You can customize the name if you wish. Click Install.
5. **Pin to Taskbar:** The PWA for the AI tool will immediately launch in its own window, and its icon will appear on your Taskbar. To make it permanent, right-click the icon on the Taskbar and select Pin to taskbar.
...
1. **Open the AI tool in Safari:** Navigate to the AI tool (for example, `https://gemini.google.com/app`) in Safari and sign in if necessary.
2. **Find "Add to Dock":** Go to the `File` menu in the top menu bar (next to the Apple logo).
3. **Select "Add to Dock...":** Click this option from the dropdown menu.
4. **Confirm:** A dialog will appear, allowing you to customize the name. Click Add.
